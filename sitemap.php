...
//        }
    ...
    public static function sitemapAdminInit () {
        require_once('sitemapSettingsValidation.php');
        $settingsValidation = new SitemapSettingsValidation();
        ...
        register_setting($group, 'sitemap_custom_pages',array($settingsValidation, 'validateCustomPages'));
//        settings_errors('sitemap_custom_pages');
    ...
    public static function sitemapScriptsAndStyles ($page) {
        if ($page === 'settings_page_sitemapSettings') {
            ...
            wp_enqueue_style('sitemap-admin-jqueryui-css', 'https://code.jquery.com/ui/1.13.1/themes/base/jquery-ui.css');
            ...
            wp_enqueue_script('sitemap-admin-jqueryui-js',  'https://code.jquery.com/ui/1.13.1/jquery-ui.js', array('jquery'), '1.0.0', true);
        }
    }
